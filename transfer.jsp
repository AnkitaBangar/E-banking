...
String sql = "SELECT acc_no, acc_type, uname FROM acc_details WHERE uname='"+uname+"'";
ArrayList one = BankCommons.getAccountByName(sql);
//System.out.println(one);
String sql_1 = "SELECT acc_no, acc_type, uname FROM acc_details";
	  ...
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td><label>
			...
			%>
              <option value="<%=(String)o.get(0)%>" ><%=(String)o.get(0)%> ::<%=(String)o.get(1)%> ::<%=(String)o.get(2)%></option>
              <% } %>
            </select>
          </label></td>
        </tr>
